...
export function ImageUploadErrorSnackbar({ imageMaxSize }: { imageMaxSize: number }) {
  ...
  return (
    ...
    >
      ...
      <Stack>
        <Typography color="textDark" component="p">
          File size must not exceed {imageMaxSize} MB
        </Typography>
      </Stack>
